...
//       {/* Team Board hai bên để biết ai đang đấu */}
//       <TeamBoard />
...
//             Mini Game Special
//           </span>
//           <h1 className="text-7xl font-black italic tracking-tighter bg-gradient-to-b from-white to-white/50 bg-clip-text text-transparent drop-shadow-2xl">
//             SIÊU PHÀM XẾP LY
//           </h1>
//         </motion.div>
//       </header>

//       {/* Khu vực trung tâm: Đồng hồ và Luật chơi */}
//       <main className="relative z-10 w-full max-w-4xl flex flex-col items-center gap-12">
        
//         {/* Đồng hồ bấm giờ */}
//         <div className="relative group">
//           <div className="absolute -inset-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-[4rem] blur-2xl opacity-20 group-hover:opacity-40 transition duration-1000"></div>
//           <motion.div 
//             animate={isRunning ? { scale: [1, 1.01, 1] } : {}}
//             transition={{ repeat: Infinity, duration: 2 }}
//             className="relative bg-[#0a1f2e]/80 border-2 border-white/10 backdrop-blur-3xl px-24 py-12 rounded-[3.5rem] shadow-2xl text-center"
//           >
//             <div className="text-9xl font-mono font-black tabular-nums tracking-tight mb-2">
//               {formatTime(timer)}
//             </div>
//             <div className="h-2 w-full bg-white/5 rounded-full overflow-hidden">
//                <motion.div 
//                 animate={isRunning ? { x: ['-100%', '100%'] } : { x: '-100%' }}
//                 transition={{ repeat: Infinity, duration: 1.5, ease: "linear" }}
//                 className="w-1/3 h-full bg-gradient-to-r from-transparent via-yellow-400 to-transparent"
//                />
//             </div>
//           </motion.div>
//         </div>
...
//               className="bg-green-600 hover:bg-green-500 px-16 py-6 rounded-3xl text-3xl font-black shadow-[0_10px_0_rgb(20,83,45)] active:translate-y-2 active:shadow-none transition-all"
//             >
//               BẮT ĐẦU 🚀
//             </button>
//           ) : (
//             <>
//               <button
//                 onClick={() => { setWinner('GREEN'); setIsRunning(false); }}
//                 className="bg-green-600 px-10 py-5 rounded-2xl text-xl font-black shadow-[0_8px_0_rgb(20,83,45)] active:translate-y-1 active:shadow-none transition-all uppercase"
//               >
//                 {teamA.name} Xong! ✅
//               </button>
//               <button
//                 onClick={() => { setWinner('RED'); setIsRunning(false); }}
//                 className="bg-red-600 px-10 py-5 rounded-2xl text-xl font-black shadow-[0_8px_0_rgb(153,27,27)] active:translate-y-1 active:shadow-none transition-all uppercase"
//               >
//                 {teamB.name} Xong! ✅
//               </button>
//               <button
//                 onClick={resetGame}
//                 className="bg-white/10 hover:bg-white/20 px-10 py-5 rounded-2xl text-xl font-black transition-all"
//               >
//                 RESET 🔄
//               </button>
//             </>
...
//             initial={{ opacity: 0 }}
//             animate={{ opacity: 1 }}
//             className="fixed inset-0 z-[100] bg-[#051622]/95 backdrop-blur-2xl flex items-center justify-center p-6"
//           >
//             <motion.div
...
//                 🏆
//               </motion.div>
//               <h2 className={`text-8xl font-black italic mb-4 uppercase ${winner === 'GREEN' ? 'text-green-500' : 'text-red-500'}`}>
//                 {winner === 'GREEN' ? teamA.name : teamB.name}
//               </h2>
//               <p className="text-4xl font-bold text-white/60 mb-12">
//                 HOÀN THÀNH VỚI THỜI GIAN: <span className="text-white">{formatTime(timer)}</span>
//               </p>
//               <button
//                 onClick={resetGame}
//                 className="bg-yellow-500 text-black px-20 py-8 rounded-3xl text-4xl font-black shadow-[0_12px_0_rgb(161,98,7)] hover:translate-y-2 active:shadow-none transition-all"
//               >
//                 TIẾP TỤC 🏁
//               </button>
//             </motion.div>
